...
public class NegacionUnariaExpresion extends Instruccion {
    ...
    public NegacionUnariaExpresion(Instruccion expresion, int linea, int columna) {
    ...
    public Object interpretar(Arbol arbol, TablaSimbolos tabla) {
        ...
        return switch (this.expresion.tipo.getTipoDato()) {
            ...
            default -> new ErroresExpresiones("SEMÁNTICO", "Negación unaria inválida", this.linea, this.columna);
        };
    }
}
