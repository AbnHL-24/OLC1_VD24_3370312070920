...
public class MenorQueExpresion extends OperacionBinaria {

    public MenorQueExpresion(Instruccion operadorIzq, Instruccion operadorDer, int linea, int columna) {
    ...
    protected Object realizarOperacion(Object valorIzq, Object valorDer, TipoDato tipoResultado) {
        ...
        return switch (tipoResultado) {
            ...
            default -> new ErroresExpresiones("SEMÁNTICO", "Operación menor que entre tipos no soportada", linea, columna);
        };
    }
}